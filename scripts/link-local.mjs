 ...
 *   npm run link:dev    → manifest.dev.json (entryPoint: http://localhost:3000)
 *   npm run unlink      → remove the installed directory
 *
...
const dest = join(symbiotesDir(), INSTALL_NAME)
...
console.log(`Linked ${INSTALL_NAME} (${mode}) → ${dest}`)
